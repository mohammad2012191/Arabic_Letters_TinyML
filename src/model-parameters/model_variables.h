...
const char* ei_classifier_inferencing_categories[] = { "ain", "aliph", "baa", "ch", "daad", "dal", "dhad", "faa", "gha", "haa", "hhaa", "jeem", "kaf", "kha", "laam", "meem", "noon", "qaf", "raa", "saad", "seen", "taa", "tha", "the", "ttaa", "wow", "yaa", "zaa" };
...
const ei_impulse_t impulse_632138_0 = {
    .project_id = 632138,
    .project_owner = "Mohamed Eltayeb",
    .project_name = "TinyML_Arabic",
    .impulse_id = 1,
    ...
    .tflite_output_features_count = 28,
...
ei_impulse_handle_t impulse_handle_632138_0 = ei_impulse_handle_t( &impulse_632138_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_632138_0;
